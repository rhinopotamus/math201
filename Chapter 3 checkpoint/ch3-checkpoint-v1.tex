...
Find the global minimum and global maximum values of the function \(f(x)=-2 \, x^{3} + 9 \, x^{2} - 11\) on the interval \([2,7]\). Show all your work and explain all your thinking.
