...
\pagebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Learning target DF1, version 3/30}
...
\section{Learning target DF2, version 3/30}

Suppose that $p(x) = 4x^2 - 2x + 7$.
Use the limit definition of the derivative to find $p'(x)$. 
\iffalse
\begin{enumerate}[leftmargin=0pt]
...
\section{Learning target DFa, version 3/30}
...
\section{Learning target DFb, version 3/30}
...
\section{Learning target AD2, version 3/30}
