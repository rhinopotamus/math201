...
\pagebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Learning target AD5 and AD4, version 3 FART FART DO NOT USE!!!!}
...
Consider the function
\(r(x) =-2x^{3}+18x^{2}+42x+33\).
	
	\begin{enumerate}[leftmargin=15pt]

		\item Find the critical numbers using algebra, and draw a sign chart (aka labeled number line). \\
		Use the sign chart to decide what kind of extremum happens at each critical number.\\
		\textbf{Remember, only critical numbers go on the sign chart!}
		...
		\hrulefill (AD4)
		\item Restricting the domain of this function to the interval $[-3, 4]$, what are the absolute maximum and absolute minimum values of this function, and where do they occur?

		\vspace{10em}
	
		
		\item What if we change the domain to $[-3,8]$?
