...
\item
\stxKnowl{
\( \renewcommand{\log}{\ln} g(w)= \frac{3 \, w^{2} + 5 \, w - 1}{w^{8}} \cos\left(x\right)\)
...
\item
\stxKnowl{
\[k(t)= 8 \, \cos\left(t\right)^{\frac{7}{5}}\]

\stxOuttro{
\[k' (t)= -\frac{56}{5} \, \cos\left(t\right)^{\frac{2}{5}} \sin\left(t\right)\]
...
\item
\stxKnowl{
\[f(w)= 8 \, \cos\left(w^{\frac{7}{5}}\right)\]

\stxOuttro{
\[f' (w)= -\frac{56}{5} \, w^{\frac{2}{5}} \sin\left(w^{\frac{7}{5}}\right)\]
...
\item
\stxKnowl{
\[h(x)= \sin\left(-2 \, x^{2} + 5 \, x - 4\right)\]

\stxOuttro{
\[h' (x)= -{\left(4 \, x - 5\right)} \cos\left(-2 \, x^{2} + 5 \, x - 4\right)\]
...
\item
\stxKnowl{
\[g(y)= -{\left(5 \, y - 4 \, e^{y} + 4\right)}^{5}\]

\stxOuttro{
\[g' (y)= 5 \, {\left(5 \, y - 4 \, e^{y} + 4\right)}^{4} {\left(4 \, e^{y} - 5\right)}\]
