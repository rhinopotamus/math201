...
\stxKnowl{
 ...
 SOME KIND OF INSTRUCTION NOT TO USE QUOTIENT ETC
...
\item 
\stxKnowl{
 \(C(t) = \dfrac{\sqrt{\dfrac{\arcsin(2\pi+3)}{\arcsin(3\pi-2)} + 
                 e^{i \pi/2}\cdot \cos\left(-\dfrac{34}{\sqrt{5}}\right)}}
                {\ln\Big(\cos\big(\sin(\cos(7))\big)\Big) \cdot
                \arctan(7^e+e^7)}\) \quad
(Hint: Look carefully!)
...
\section{Learning target DF7 and AD2, version 1}
\providecommand{\stxKnowl}{}\renewcommand{\stxKnowl}[1]{#1}
\providecommand{\stxOuttro}{}\renewcommand{\stxOuttro}[1]{#1}
\providecommand{\stxTitle}{}\renewcommand{\stxTitle}[1]{#1}
% Comment next line to show outtros
