...
%	Find your average velocity over the last 10 minutes of travel. Label your result using proper notation and include units on your answer.
	...
	Use the data to determine the average velocity of the ball on the interval $[0.7,0.76]$.	Include units on your answer.
		...
		\begin{center}
		\scalebox{0.2}{\includegraphics{images/LT1-11.png}}
		\end{center}
...
\ \hspace{0.5in}  \scalebox{0.4}{\includegraphics{images/CP4-01-ff'.png}}
...
\begin{center}  
  \scalebox{0.6}{\includegraphics{images/CP4-4-S23.jpg}} \hspace{0.2in} \scalebox{0.6}{\includegraphics{images/CP4-4-S23-blank.jpg}} \\
\end{center}
...
\scalebox{0.4}{\includegraphics{images/CP4-01-blank.png}} \\
...
\begin{center}  
  \scalebox{0.45}{\includegraphics{images/LT7-CP6.png}} \\
\end{center}	
...
\begin{center}  
\scalebox{0.45}{\includegraphics{images/LT8-CP6.png}} \\
\end{center}
...
\scalebox{0.4}{\includegraphics{images/HW10-S24-PW.jpg}} \\
...
\pagebreak
	...
	\begin{figure}
	\begin{center}	
	   \scalebox{0.3}{\includegraphics{images/CP11-LT13.jpg}}
