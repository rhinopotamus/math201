...
\begin{document}
\section{PS7: Derivative shortcut rules}
...
\vskip 1em 
\item
Differentiate \(W(x) =\dfrac{x^4 - 6x + 10}{\sqrt{7x + 8}}\).
\vskip 1em 
\item
Differentiate \(g(q) = \dfrac{q^{5}}{\ln(q^5 + \frac13)}\).
\vskip 1em 
\item
...
\item
Find $\dfrac{dB}{dx}$ if 
\(B = \dfrac{e^{x + \pi}}{\sin(\pi x)}\).
\vskip 1em 
\item 
Differentiate \(h(p) = \dfrac{(2 p - 1)^{1/4}}{\cos(p + 5)}\).
\vskip 1em 
\item
Differentiate \(f(q)=(\cos q)\left(\sin {\left(\frac{2}{\pi} q\right)}\right)\).
\vskip 1em 
\item
Differentiate \(G(x) = p x^5 + q x^3 - x^r\), \\
where \(p,q\) and \(r\) are constants.
\vskip 1em 
\item
Find the derivative of \\ \(V(x) = \left(3 x - \frac14 \right)^{-4} - (5x)^{5/4}\).
\vskip 1em 
\item
...
&& \textrm{power rule)} \\ \\
&= \frac{[e^{-3t}] \cdot
         \blue{\left[-\sin(t^2-1)\cdot\diff{t}(t^2-1)\right]} - 
		 [\cos(t^2-1)]\cdot 
         [e^{-3t}\cdot(-3)]}
		{[e^{-3t}]^2}
& \textrm{(chain rule, } \\
...
&= \frac{[e^{-3t}] \cdot
         [-\sin(t^2-1)\cdot 
         \blue{\left[\diff{t}(t^2) - \diff{t}(1)\right]}] - 
		 [\cos(t^2-1)]\cdot 
         [e^{-3t}\cdot(-3)]}
		{[e^{-3t}]^2}
& \textrm{(sum rule)} \\ \\
&= \frac{[e^{-3t}] \cdot
         ...
         [e^{-3t}\cdot(-3)]}
		{[e^{-3t}]^2}
& \vspace{-2em} \textrm{(power rule,} \\
&& \vspace{-2em} \textrm{constant function rule)}
\end{align*}
...
{ \everymath{\displaystyle}
    \begin{itemize}[label=\(\square\)]
        ...
        \item chain rule: $[f(g(x))]' = f'(g(x)) \cdot g'(x)$, or in other words, $\dfrac{d}{dx}\left[ f(g(x)) \right] = f'(g(x)) \cdot \dfrac{d}{dx}\left[ g(x) \right]$
