...
\end{center}
	...
	A historical note: Newton actually used dots: $\dot f(x)$. The prime was first used by Lagrange, but it reminded everyone so much of Newton's dots that they tend to think of them together. Newton dot notation is commonly used in physics to denote \textit{specifically} a derivative \textit{with respect to time}.
