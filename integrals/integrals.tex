...
\begin{enumerate}[leftmargin=0.5cm]
    \item (IN1) Shade in the area under \(c(t)\) between \(t = 10\) and \(t = 30\). Use some simple geometry to calculate this area. Give units. (Hint: Tell me the units of both the height and the width.)
    \item 
    (INx) Write a sentence explaining what the answer to part 1 \textit{means} in the context of the person exercising. (Hint: Think about the units.)
    \item
